<template>
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title theme-text-color">Individual Records</h5>
          ...
          <div class="modal-content">
            <div class="modal-header">
              <div class="section-title">
                <h5 class="c-theme-red">Individual Apply Form</h5>
              </div>
              <button
                ref="closeThisModal"
                type="button"
                ...
                <div>
                  <div class="row g-3">
                    ...
                    <div class="col-md-6 col-12">
                      <label for="individual_full_name" class="form-label"
                        >Full Name<i class="text-danger">*</i></label
                      >
                      <input
                        type="text"
                        class="form-control"
                        v-model="individualForm.full_name"
                        :class="{
                          'is-invalid': individualFormErrors.full_name,
                        }"
                      />
                      <div
                        v-if="individualFormErrors.full_name"
                        class="invalid-feedback"
                      >
                    ...
                    <!-- Phone Number -->
                    <div class="col-md-6 col-12">
                      <label for="individual_phone_number" class="form-label"
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': individualFormErrors.phone_number,
                        }"
                      />
                      <div
                        v-if="individualFormErrors.phone_number"
                        class="invalid-feedback"
                      >
                    ...
                    <!-- Status -->
                    <div class="col-md-6 col-12">
                      <label for="individual_status" class="form-label"
                      ...
                      <Multiselect
                        ...
                        :searchable="true"
                        :class="{
                          'is-invalid': individualFormErrors.status,
                        }"
                      />

                      <div
                        v-if="individualFormErrors.status"
                        class="invalid-feedback"
                      >
                    ...
                    <!-- Tracking ID -->
                    <div class="col-md-6 col-12">
                      <label for="individual_tracking_id" class="form-label"
                        >Tracking ID<i class="text-danger">*</i></label
                      >
                      <input
                        type="text"
                        class="form-control"
                        v-model="individualForm.tracking_id"
                        :class="{
                          'is-invalid': individualFormErrors.tracking_id,
                        }"
                      />
                      <div
                        v-if="individualFormErrors.tracking_id"
                        class="invalid-feedback"
                      >
                    ...
                    <!-- Amount -->
                    <div class="col-md-6 col-12">
                      <label for="individual_amount" class="form-label"
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': individualFormErrors.amount,
                        }"
                      />
                      <div
                        v-if="individualFormErrors.amount"
                        class="invalid-feedback"
                      >
                    ...
                    <!-- Visa Fee -->
                    <div class="col-md-6 col-12">
                      <label for="visa_fee" class="form-label">Visa Fee<i class="text-danger">*</i></label>
                      <input
                        type="number"
                        class="form-control"
                        v-model="individualForm.visa_fee"
                        :class="{
                          'is-invalid': individualFormErrors.visa_fee,
                        }"
                      />
                      <div
                        v-if="individualFormErrors.visa_fee"
                        class="invalid-feedback"
                      >
                    ...
                    <!-- Gmail -->
                    <div class="col-md-6 col-12">
                      <label for="individual_gmail" class="form-label"
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': individualFormErrors.gmail,
                        }"
                      />
                      <div
                        v-if="individualFormErrors.gmail"
                        class="invalid-feedback"
                      >
                    ...
                    <div class="col-md-6 col-12">
                      ...
                      <input
                        type="text"
                        class="form-control"
                        v-model="individualForm.pak_visa_password"
                        :class="{
                          'is-invalid': individualFormErrors.pak_visa_password,
                        }"
                      />
                      <div
                        v-if="individualFormErrors.pak_visa_password"
                        class="invalid-feedback"
                      >
                    ...
                    <!-- Gmail Password -->
                    <div class="col-md-6 col-12">
                      <label for="individual_gmail_password" class="form-label"
                        >Gmail Password<i class="text-danger">*</i></label
                      >
                      <input
                        type="gmail"
                        class="form-control"
                        v-model="individualForm.gmail_password"
                        :class="{
                          'is-invalid': individualFormErrors.gmail_password,
                        }"
                      />
                      <div
                        v-if="individualFormErrors.gmail_password"
                        class="invalid-feedback"
                      >
                    ...
                    <!-- Gender -->
                    <div class="col-md-6 col-12">
                      <label for="individual_gender" class="form-label"
                      ...
                      <Multiselect
                        ...
                        :searchable="true"
                        :class="{
                          'invalid-bg': individualFormErrors.gender,
                        }"
                      />

                      <div
                        v-if="individualFormErrors.gender"
                        class="invalid-feedback"
                      >
                    ...
                    <!-- referral -->
                    <div class="col-md-6 col-12">
                      <label for="referral" class="form-label">Referrals </label>
                      <Multiselect
                        v-model="individualForm.referral"
                        :options="pluckedReferrals"
                        :searchable="true"
                        :class="{
                          'invalid-bg': individualFormErrors.referral,
                        }"
                      />

                      <div
                        v-if="individualFormErrors.referral"
                        class="invalid-feedback"
                      >
                  ...
                  >
                    {{ individualFormStatus === 1 ? "Save" : "Saving..." }}
                  </button>
                </div>
              </div>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      statusOptions: ["Initial", "Applied", "Refunded", "Rejected", "Approved"], // Status options
  ...
  methods: {
    ...
    submitIndividualForm() {
      ...
      axios
        .post(route("api.individual.customer.store"), this.individualForm, {
          headers: {
