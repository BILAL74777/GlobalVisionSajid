...
export default {
    ...
    methods: {
        ...
        validateReferralForm() {
            this.referralErrors = {};
            if (!this.referralForm.name)
                this.referralErrors.name = "Name is required.";
            if (!this.referralForm.email)
                this.referralErrors.email = "Email is required.";
            if (!this.referralForm.phone)
                this.referralErrors.phone = "Phone Number is required.";
            if (!this.referralForm.commission)
                this.referralErrors.commission = "Commission is required.";
        },
        submitReferral() {
